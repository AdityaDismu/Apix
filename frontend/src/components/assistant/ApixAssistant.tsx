  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#675B69] text-white shadow-[0_12px_35px_rgba(70,61,69,0.18)] transition hover:-translate-y-0.5 hover:bg-[#756978] focus:outline-none focus:ring-4 focus:ring-[#6B5A78]/20"
      >
        <MessageCircle size={22} />
        <span className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#718A78] text-[9px] font-bold">AI</span>
      </button>
    );
  }
